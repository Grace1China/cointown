    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="日期" prop="createdAt" width="180">
         ...
         <el-table-column align="left" label="时间" prop="currentTime" width="180">
          ...
          <el-table-column align="left" label="对话Id" prop="chatId" width="300" />
          <el-table-column align="left" label="话题Id" prop="topicId" width="120" />
          <el-table-column align="left" label="HITS" prop="hits" width="120" />
          <el-table-column align="left" label="hitAt" prop="hitAt" width="120" />

          <!-- <el-table-column align="left" label="消息体" prop="lastMessageText" width="120" /> -->
          <!-- <el-table-column align="left" label="消息体模版" prop="template" width="120" /> -->
       ...
       <template #header>
          ...
          <el-form :model="formData" label-position="top" ref="elFormRef" :rules="rule" label-width="80px">
            <el-form-item label="时间:"  prop="currentTime" >
              <el-date-picker v-model="formData.currentTime" type="date" style="width:100%" placeholder="选择日期" :clearable="true"  />
            </el-form-item>
    ...
    <el-drawer destroy-on-close size="800" v-model="detailShow" :show-close="true" :before-close="closeDetailShow">
            <el-descriptions column="1" border>
                    ...
                    <el-descriptions-item label="消息体">
                        {{ detailFrom.lastMessageText }}
                    </el-descriptions-item>
                    <el-descriptions-item label="消息体模版">
                        {{ detailFrom.template }}
                    </el-descriptions-item>
            </el-descriptions>
        </el-drawer>
