	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				...
				ImportPath:        `"github.com/Grace1China/cointown/server/api/v1/example"`,
		...
		},
		{
			...
			fields: fields{
				...
				ImportPath:        `"github.com/Grace1China/cointown/server/router/example"`,
				StructName:        "Example",
				PackageName:       "example",
		...
		},
		{
			...
			fields: fields{
				...
				ImportPath:        `"github.com/Grace1China/cointown/server/service/example"`,
